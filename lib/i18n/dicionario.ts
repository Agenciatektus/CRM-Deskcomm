...
export const DICIONARIO: Traducoes = {
  ...
  "Lead sem responder há um tempo": { es: "Lead sin responder desde hace un tiempo" },
  "Você escolhe os negócios no Kanban e inscreve em lote.": { es: "Usted elige los negocios en el Kanban y los inscribe en lote." },
  "Só entra quem chegar à etapa depois de publicar.": { es: "Solo entra quien llegue a la etapa después de publicar." },
  "Vale a etiqueta posta depois de publicar. Etiqueta no contato inscreve o negócio aberto dele neste funil.": { es: "Vale la etiqueta puesta después de publicar. La etiqueta en el contacto inscribe su negocio abierto en este embudo." },
  "O cliente escreveu e ninguém respondeu nesse tempo. Conta o número da cadência.": { es: "El cliente escribió y nadie respondió en ese tiempo. Cuenta el número de la cadencia." },
  "Mandamos a última mensagem e o lead não respondeu nesse tempo.": { es: "Enviamos el último mensaje y el lead no respondió en ese tiempo." },
  "A cadência para sozinha quando o lead responde.": { es: "La cadencia se detiene sola cuando el lead responde." },
  "Etapa que dispara a cadência": { es: "Etapa que dispara la cadencia" },
  "Etiqueta que dispara a cadência": { es: "Etiqueta que dispara la cadencia" },
  "Ex.: Lista fria": { es: "Ej.: Lista fría" },
  "Quanto tempo": { es: "Cuánto tiempo" },
  "Unidade de tempo": { es: "Unidad de tiempo" },
  "Escreva a etiqueta que coloca o negócio na cadência.": { es: "Escriba la etiqueta que pone el negocio en la cadencia." },
  "A etiqueta tem no máximo 60 caracteres.": { es: "La etiqueta tiene como máximo 60 caracteres." },
  "O tempo sem resposta do time vai de 5 minutos a 7 dias.": { es: "El tiempo sin respuesta del equipo va de 5 minutos a 7 días." },
  "O tempo sem resposta do lead vai de 1 hora a 30 dias.": { es: "El tiempo sin respuesta del lead va de 1 hora a 30 días." },
  "Na cadência, use etapa do funil, etiqueta, tempo sem resposta ou a inscrição manual.": { es: "En la cadencia, use etapa del embudo, etiqueta, tiempo sin respuesta o la inscripción manual." },
  "Etiqueta adicionada": { es: "Etiqueta añadida" },
  "Cliente sem resposta do time": { es: "Cliente sin respuesta del equipo" },
  "Lead sem responder": { es: "Lead sin responder" },
  "Quando a cadência para": { es: "Cuándo se detiene la cadencia" },
  "Quando o lead responde, a cadência para sempre.": { es: "Cuando el lead responde, la cadencia se detiene siempre." },
  "Negócio ganho ou perdido": { es: "Negocio ganado o perdido" },
  "Alguém do time mandou mensagem ao lead": { es: "Alguien del equipo le escribió al lead" },
  "Quando o lead ganhar a etiqueta": { es: "Cuando el lead reciba la etiqueta" },
  "Ex.: Reunião agendada, Não perturbe": { es: "Ej.: Reunión agendada, No molestar" },
  "Separe por vírgula. Vale etiqueta do negócio ou do contato.": { es: "Separe con comas. Vale la etiqueta del negocio o del contacto." },
  "Quando o negócio entrar na etapa": { es: "Cuando el negocio entre en la etapa" },
  "Uma etapa de saída não é deste funil.": { es: "Una etapa de salida no es de este embudo." },
  "Uma etapa de saída está arquivada.": { es: "Una etapa de salida está archivada." },
  ...
  "sem uso": { es: "sin uso" },
  // Cadência de prospecção (components/cadencia, app/app/pipelines/[id]).
  "Modo do funil": { es: "Modo del embudo" },
  "Kanban": { es: "Kanban" },
  "Cadências": { es: "Cadencias" },
  "Pausar todas as cadências": { es: "Pausar todas las cadencias" },
  "Pausadas: nenhuma mensagem de cadência sai até retomar. Ninguém perde o lugar na régua.": { es: "En pausa: ningún mensaje de cadencia sale hasta reanudar. Nadie pierde su lugar en la secuencia." },
  "Use se o número estiver em risco ou se uma mensagem errada estiver no ar.": { es: "Úsalo si el número está en riesgo o si hay un mensaje equivocado en el aire." },
  "Não foi possível mudar a pausa.": { es: "No fue posible cambiar la pausa." },
  "Nome da nova cadência": { es: "Nombre de la nueva cadencia" },
  "Nome da nova cadência, ex.: Lojistas lista fria": { es: "Nombre de la nueva cadencia, ej.: Tiendas lista fría" },
  "Não foi possível criar a cadência.": { es: "No fue posible crear la cadencia." },
  "Carregando cadências…": { es: "Cargando cadencias…" },
  "Não foi possível carregar as cadências.": { es: "No fue posible cargar las cadencias." },
  "Nenhuma cadência neste funil": { es: "Ninguna cadencia en este embudo" },
  "Uma cadência manda uma sequência de mensagens pelo WhatsApp e para sozinha quando o lead responde.": { es: "Una cadencia envía una secuencia de mensajes por WhatsApp y se detiene sola cuando el lead responde." },
  "Entra quem chega em": { es: "Entra quien llega a" },
  "Inscrição manual pelo Kanban": { es: "Inscripción manual desde el Kanban" },
  "na régua agora": { es: "en la secuencia ahora" },
  "Carregando a cota do número…": { es: "Cargando la cuota del número…" },
  "Não foi possível ler a cota do número.": { es: "No fue posible leer la cuota del número." },
  "Envios hoje": { es: "Envíos hoy" },
  "Uso da cota diária do número": { es: "Uso de la cuota diaria del número" },
  "O número está desconectado: nada sai até reconectar.": { es: "El número está desconectado: nada sale hasta reconectar." },
  "O teto de hoje vem do aquecimento do número, não do limite diário.": { es: "El tope de hoy viene del calentamiento del número, no del límite diario." },
  "Cota de hoje esgotada: os próximos envios saem na abertura do próximo dia útil.": { es: "Cuota de hoy agotada: los próximos envíos salen al abrir el próximo día hábil." },
  "Carregando a cadência…": { es: "Cargando la cadencia…" },
  "Não foi possível abrir a cadência.": { es: "No fue posible abrir la cadencia." },
  "Esta cadência tem ramificações que o editor em lista não mostra.": { es: "Esta cadencia tiene ramificaciones que el editor en lista no muestra." },
  "Abrir no editor avançado": { es: "Abrir en el editor avanzado" },
  "Cadência publicada.": { es: "Cadencia publicada." },
  "Nome da cadência": { es: "Nombre de la cadencia" },
  "Quem entra na cadência": { es: "Quién entra en la cadencia" },
  "Só quem eu inscrever (seleção no Kanban)": { es: "Solo a quien yo inscriba (selección en el Kanban)" },
  "Todo negócio que entrar em": { es: "Todo negocio que entre en" },
  "A cadência para sozinha quando o lead responde. Só entra quem chegar à etapa depois de publicar.": { es: "La cadencia se detiene sola cuando el lead responde. Solo entra quien llegue a la etapa después de publicar." },
  "Passos": { es: "Pasos" },
  "Salvar e republicar": { es: "Guardar y republicar" },
  "Política de envio": { es: "Política de envío" },
  "Inscrever na cadência": { es: "Inscribir en la cadencia" },
  "negócio(s) selecionado(s). Confira a prévia antes de confirmar.": { es: "negocio(s) seleccionado(s). Revisa la vista previa antes de confirmar." },
  "Nenhuma cadência publicada neste funil. Crie e publique uma na aba Cadências.": { es: "Ninguna cadencia publicada en este embudo. Crea y publica una en la pestaña Cadencias." },
  "Cadência": { es: "Cadencia" },
  "Escolha a cadência": { es: "Elige la cadencia" },
  "entram hoje": { es: "entran hoy" },
  "cabem": { es: "caben" },
  "hoje nesta cadência": { es: "hoy en esta cadencia" },
  "Não foi possível inscrever.": { es: "No fue posible inscribir." },
  "Ver prévia": { es: "Ver vista previa" },
  "inscrito(s) na cadência.": { es: "inscrito(s) en la cadencia." },
  "Subir passo": { es: "Subir paso" },
  "Descer passo": { es: "Bajar paso" },
  "Remover passo": { es: "Quitar paso" },
  "Esperar": { es: "Esperar" },
  "Horas de espera": { es: "Horas de espera" },
  "Adicionar ou remover": { es: "Añadir o quitar" },
  "ex.: sem-resposta": { es: "ej.: sin-respuesta" },
  "Mover de etapa": { es: "Mover de etapa" },
  "Variações da mensagem": { es: "Variaciones del mensaje" },
  "Variação": { es: "Variación" },
  "Texto da variação": { es: "Texto de la variación" },
  "Oi {{primeiro_nome|tudo bem}}! {Vi|Conheci} a {{empresa}} e …": { es: "Oi {{primeiro_nome|tudo bem}}! {Vi|Conheci} a {{empresa}} e …" },
  "Inserir:": { es: "Insertar:" },
  "Remover variação": { es: "Quitar variación" },
  "Use {a|b} para alternar palavras. Cada lead recebe sempre a mesma variação.": { es: "Usa {a|b} para alternar palabras. Cada lead recibe siempre la misma variación." },
  "Número que envia": { es: "Número que envía" },
  "Para trocar o número, desligue a cadência antes.": { es: "Para cambiar el número, desactiva la cadencia antes." },
  "Dias e horário de envio": { es: "Días y horario de envío" },
  "Dias da semana": { es: "Días de la semana" },
  "Intervalo mínimo (s)": { es: "Intervalo mínimo (s)" },
  "Intervalo máximo (s)": { es: "Intervalo máximo (s)" },
  "Entre duas mensagens automáticas do número, espera um tempo sorteado nesse intervalo.": { es: "Entre dos mensajes automáticos del número, espera un tiempo sorteado en ese intervalo." },
  "Novas inscrições por dia": { es: "Nuevas inscripciones por día" },
  "Base legal do contato frio (LIA)": { es: "Base legal del contacto frío (LIA)" },
  "Ex.: LIA 2026-09, prospecção B2B de lojistas por interesse legítimo": { es: "Ej.: LIA 2026-09, prospección B2B de tiendas por interés legítimo" },
  "Obrigatória para publicar. Fica registrada no contato quando ele entra na cadência.": { es: "Obligatoria para publicar. Queda registrada en el contacto cuando entra en la cadencia." },
  "Lead de amostra": { es: "Lead de muestra" },
  "Nenhum lead neste funil": { es: "Ningún lead en este embudo" },
  "Prévia": { es: "Vista previa" },
  "Não foi possível gerar a prévia.": { es: "No fue posible generar la vista previa." },
  "Esta variação não renderiza.": { es: "Esta variación no se genera." },
  "Falta um dado deste lead. Use um fallback, ex.: {{primeiro_nome|tudo bem}}.": { es: "Falta un dato de este lead. Usa un valor alternativo, ej.: {{primeiro_nome|tudo bem}}." },
  "Variável que não existe. Confira o nome entre {{ }}.": { es: "Variable que no existe. Revisa el nombre entre {{ }}." },
  "Uma variação {a|b} está sem fechar.": { es: "Una variación {a|b} está sin cerrar." },
  "No ar": { es: "Activa" },
  "não é deste funil": { es: "no es de este embudo" },
  "negócio já fechado": { es: "negocio ya cerrado" },
  "negócio sem contato": { es: "negocio sin contacto" },
  "contato indisponível": { es: "contacto no disponible" },
  "contato bloqueado ou pediu para sair": { es: "contacto bloqueado o pidió salir" },
  "telefone pediu para sair em outro cadastro": { es: "el teléfono pidió salir en otro registro" },
